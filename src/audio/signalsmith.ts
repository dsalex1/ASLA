 ...
 * carries on with the tempo applied and the pitch never put back — which is what shipped in
 * v0.0.34. Two separate passes break it: the dev dep optimiser lowers its class fields into
 * `__publicField` helpers a worklet scope has no definition for, and the production minifier
 * renames `_scriptName`.
 *
