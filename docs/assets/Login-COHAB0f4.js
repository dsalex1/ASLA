...
import { u as M, _ as C } from './auth-CFdADcfQ.js'
...
const H = { key: 0, class: 'd-flex justify-center align-center', style: { height: '100vh' } },
  ...
  Z = B({
    ...
    setup(V) {
      ...
      async function x() {
        try {
          await D(L, a.email), (i.value = 'Password reset email sent.'), (t.value = '')
        } catch {
        ...
        return A(_).user === void 0
          ...
          : (r(),
            c(
              ...
              {
                default: n(() => [
                  o(P, { class: 'mt-12 border rounded', width: '128', height: '128', src: C }),
                  ...
                  o(
                    ...
                    { 'max-width': '400', width: '400', class: 'mx-auto' },
                    {
                      default: n(() => [
                        K,
                        i.value
                          ? (r(), c(y, { key: 0, color: 'success mb-2', text: i.value }, null, 8, ['text']))
                          : p('', !0),
                        o(
                          T,
                          { 'validate-on': 'submit', onSubmit: k(g, ['prevent']), width: '100%' },
                          {
                            default: n(() => [
                              o(
                                v,
                              ...
                              t.value ? (r(), S('p', q, I(t.value), 1)) : p('', !0),
                              o(
                                f,
                              ...
                              t.value
                                ? (r(),
                                  c(
                                    f,
                                    { key: 1, variant: 'text', color: 'primary', class: 'mt-4', onClick: x },
