...
var Oe = (e, t, s) => (t in e ? Ne(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s }) : (e[t] = s))
var I = (e, t, s) => Oe(e, typeof t != 'symbol' ? t + '' : t, s)
import { u as Ke, _ as Ge } from './sheetBaseDirectory-DwNixpuI.js'
import {
  p as re,
  l as Te,
  m as ze,
  ...
  al as Tt,
  am as _t,
} from './index-Vkwy1c4v.js'
import { u as Et, m as $t, f as Pt, a as Mt } from './helpers-BHLi48aJ.js'
import { _ as At } from './AppLayout.vue_vue_type_script_setup_true_lang-DhLF5yfz.js'
import { _ as Vt } from './plugin-vue_export-helper-DlAUqK2U.js'
import './auth-CFdADcfQ.js'
const Lt = re(
    { ...Te(ze({ collapseIcon: '$treeviewCollapse', expandIcon: '$treeviewExpand' }), ['subgroup']) },
    'VTreeviewGroup'
  ),
  Ce = oe()({
    name: 'VTreeviewGroup',
    ...
    setup(e, t) {
      ...
      const i = N(),
        n = A(() => {
          var d
          return (d = i.value) != null && d.isOpen ? e.collapseIcon : e.expandIcon
        }),
        l = A(() => {
          var d
          return {
            VTreeviewItem: {
              prependIcon: void 0,
              appendIcon: void 0,
              active: (d = i.value) == null ? void 0 : d.isOpen,
              toggleIcon: n.value,
            },
          }
        })
      return (
        ce(() => {
          ...
          return u(ue, z(d, { ref: i, class: ['v-treeview-group', e.class], subgroup: !0 }), {
            ...s,
                  ...
                  u(se, null, [
                    u(
                      ...
                      { defaults: l.value },
                      {
                        default: () => {
                          var f
                          return [(f = s.activator) == null ? void 0 : f.call(s, c)]
                        },
                      }
                    ),
                  ])
  ...
  Bt = re({ loading: Boolean, toggleIcon: He, ...je({ slim: !0 }) }, 'VTreeviewItem'),
  le = oe()({
    name: 'VTreeviewItem',
    props: Bt(),
    setup(e, t) {
      ...
      const l = Xe(e, s),
        d = A(() => (e.value === void 0 ? l.href.value : e.value)),
        c = N(),
        {
          activate: f,
          isActivated: m,
        ...
        T = A(() => E.activatable.value && k),
        { densityClasses: v } = qe(e, 'v-list-item'),
        o = A(() => ({ isActive: m.value, select: x, isSelected: g.value, isIndeterminate: p.value })),
        a = A(() => {
          var y
          return (
            !e.disabled &&
            e.link !== !1 &&
            (e.link || l.isClickable.value || (e.value != null && !!((y = c.value) != null && y.list)))
          )
        })
      function r(y) {
        var w, $
        !a.value ||
          ...
          (E.activatable.value &&
            (T.value
              ? f(!m.value, y)
              : ($ = c.value) == null || $.activate(!((w = c.value) != null && w.isActivated), y)))
      }
      function b(y) {
        ;(y.key === 'Enter' || y.key === ' ') && (y.preventDefault(), r(y))
      }
      const C = Je($e, { visibleIds: N() }).visibleIds
      return (
        ce(() => {
          var O
          const y = i.title || e.title != null,
            w = i.subtitle || e.subtitle != null,
            $ = he.filterProps(e),
            W = i.prepend || e.toggleIcon
          return T.value
            ? Qe(
                u(
                  'div',
                  {
                    class: [
                      ...
                      {
                        'v-list-item--active': m.value || g.value,
                        'v-treeview-item--filtered': C.value && !C.value.has(S.value),
                      },
                      v.value,
                      e.class,
                    ],
                  ...
                  [
                    u(se, null, [
                      et(m.value || g.value, 'v-list-item'),
                      e.toggleIcon &&
                        u(
                          fe,
                          { start: !1 },
                          {
                            default: () => [
                              u(
                                ...
                                {
                                  loader() {
                                    return u(me, { indeterminate: 'disable-shrink', size: '20', width: '2' }, null)
                                  },
                                }
                              ),
                            ],
                      ...
                      y &&
                        u(
                          ...
                          { key: 'title' },
                          {
                            default: () => {
                              var V
                              return [((V = i.title) == null ? void 0 : V.call(i, { title: e.title })) ?? e.title]
                            },
                          }
                        ),
                      w &&
                        u(
                          ...
                          { key: 'subtitle' },
                          {
                            default: () => {
                              var V
                              return [
                                ((V = i.subtitle) == null ? void 0 : V.call(i, { subtitle: e.subtitle })) ?? e.subtitle,
                              ]
                            },
                          }
                        ),
                      (O = i.default) == null ? void 0 : O.call(i, o.value),
                    ]),
                  ]
                ),
                  ...
                  prepend: W
                    ? (V) => {
                        ...
                        return u(se, null, [
                          ...
                          (J = i.prepend) == null ? void 0 : J.call(i, V),
                        ])
                      }
                    : void 0,
                }
    ...
    setup(e, t) {
      ...
      function l(c) {
        return new Promise((f) => {
          var m, x
          if (!((m = e.items) != null && m.length) || !e.loadChildren) return f()
          if (((x = c == null ? void 0 : c.children) == null ? void 0 : x.length) === 0) {
            ;(n.value = c.value), e.loadChildren(c).then(f)
            return
          }
          f()
        }).finally(() => {
      ...
      return () => {
        ...
        return (
          ...
          ((f = e.items) == null
            ...
            : f.map((m) => {
                var v
                let { children: x, props: g, raw: p } = m
                const k = n.value === p.value,
                  E = {
                    prepend: (o) => {
                      var a
                      return u(se, null, [
                        e.selectable &&
                          (!x || (x && !['leaf', 'single-leaf'].includes(e.selectStrategy))) &&
                          u('div', null, [
                            u(
                              nt,
                              {
                                key: p.value,
                                modelValue: o.isSelected,
                                loading: k,
                                indeterminate: o.isIndeterminate,
                                onClick: rt(() => d(o.select, o.isSelected), ['stop']),
                                onKeydown: (r) => {
                                  ;['Enter', 'Space'].includes(r.key) &&
                                    (r.stopPropagation(), d(o.select, o.isSelected))
                                },
                              },
                              null
                            ),
                          ]),
                        (a = i.prepend) == null ? void 0 : a.call(i, { ...o, item: p }),
                      ])
                    },
                    append: i.append
                      ? (o) => {
                          var a
                          return (a = i.append) == null ? void 0 : a.call(i, { ...o, item: p })
                        }
                      : void 0,
                    title: i.title
                      ? (o) => {
                          var a
                          return (a = i.title) == null ? void 0 : a.call(i, { ...o, item: p })
                        }
                      : void 0,
                  },
                  S = Ce.filterProps(g),
                  T = ie.filterProps(e)
                return x
                  ? u(Ce, z({ value: g == null ? void 0 : g.value }, S), {
                      activator: (o) => {
                        let { props: a } = o
                        const r = { ...g, ...a, value: g == null ? void 0 : g.value }
                        return u(le, z(r, { loading: k, onClick: () => l(p) }), E)
                      },
                      default: () => u(ie, z(T, { items: x }), i),
                    })
                  : ((v = i.item) == null ? void 0 : v.call(i, { props: g })) ?? u(le, g, E)
              }))
        )
      }
    },
...
function Me(e) {
  ...
  for (const s of e) t.push(s), s.children && Me(s.children, t)
  return t
}
const Ft = re(
    {
      ...
      ...ot({ filterKeys: ['title'] }),
      ...Pe(),
      ...Te(at({ collapseIcon: '$treeviewCollapse', expandIcon: '$treeviewExpand', slim: !0 }), ['nav']),
    },
    'VTreeview'
  ),
  Rt = oe()({
    ...
    setup(e, t) {
      ...
      const { items: i } = lt(e),
        ...
        f = pe(e, 'selected'),
        m = N(),
        x = A(() => (e.openAll ? v(i.value) : e.opened)),
        g = A(() => Me(i.value)),
        p = M(e, 'search'),
        { filteredItems: k } = dt(e, g, p),
        E = A(() => (p.value ? new Set(k.value.flatMap((o) => [...S(o.props.value), ...T(o.props.value)])) : null))
      function S(o) {
        var b
        const a = []
        let r = o
        for (; r != null; ) a.unshift(r), (r = (b = m.value) == null ? void 0 : b.parents.get(r))
        return a
      }
      function T(o) {
        var b, C
        const a = [],
          r = (((b = m.value) == null ? void 0 : b.children.get(o)) ?? []).slice()
        for (; r.length; ) {
          const y = r.shift()
          y && (a.push(y), r.push(...(((C = m.value) == null ? void 0 : C.children.get(y)) ?? []).slice()))
        }
        return a
      }
      function v(o) {
        let a = []
        for (const r of o) r.children && (a.push(r.value), r.children && (a = a.concat(v(r.children))))
        return a
      }
      return (
        ct($e, { visibleIds: E }),
        ...
        ce(() => {
          ...
          return u(
            ...
            z({ ref: m }, o, {
              ...
              opened: x.value,
              activated: c.value,
              'onUpdate:activated': (r) => (c.value = r),
              selected: f.value,
              'onUpdate:selected': (r) => (f.value = r),
            }),
            { default: () => [u(ie, z(a, { items: i.value }), s)] }
          )
        }),
        { open }
      )
...
const Kt = /(auto|scroll)/,
  ae = (e, t) => getComputedStyle(e, null).getPropertyValue(t),
  Gt = (e) => Kt.test(ae(e, 'overflow') + ae(e, 'overflow-y') + ae(e, 'overflow-x')),
  de = (e) => (!e || e === document.body ? document.body : Gt(e) ? e : de(e.parentNode))
var Ve = null
function q() {
  clearTimeout(Ve)
}
function zt(e, t, s, i, n) {
  ...
  var m = l.width,
    x = l.height
  d && ((m = document.documentElement.clientWidth), (x = document.documentElement.clientHeight))
  var g = n,
    p = n,
    k = x - n,
    E = m - n,
    ...
    v = f < g,
    o = f > k
  if (!(S || T || v || o)) return q(), !1
  var a = Math.max(t.scrollWidth, t.offsetWidth, t.clientWidth),
    r = Math.max(t.scrollHeight, t.offsetHeight, t.clientHeight),
    b = a - m,
    C = r - x
  ;(function w() {
    q(), y() && (Ve = setTimeout(w, 30))
  })()
  function y() {
    var w = t.scrollLeft,
      $ = t.scrollTop
    d && ((w = window.pageXOffset), ($ = window.pageYOffset))
    var W = $ > 0,
      O = $ < C,
      V = w > 0,
      J = w < b,
    ...
    return (
      (B = Math.max(0, Math.min(b, B))),
      (F = Math.max(0, Math.min(C, F))),
      B !== w || F !== $ ? ((d ? window : t).scrollTo(B, F), !0) : !1
    )
  }
  return !0
}
var Wt = {
    ...
    methods: {
      ...
      onMouseMove(e) {
        ...
        if (e.type === 'touchmove') {
          const l = e
          if (((s = l.touches[0].clientX), (i = l.touches[0].clientY), (t = document.elementFromPoint(s, i)), !t))
            return
        } else {
          const l = e
          ;(s = l.clientX), (i = l.clientY), (t = l.target)
        }
        ...
        if (
          ...
          if (l) {
            const c = this.dragTop ? de(this.dragTop.$el) : this.scrollContainer
            zt(e, c, s, i, l)
          } else q()
          const d = new CustomEvent('easy-dnd-move', { bubbles: !0, cancelable: !0, detail: { x: s, y: i, native: e } })
          t.dispatchEvent(d)
        }
      ...
      cancelDragActions() {
        ;(this.dragInitialised = !1), clearTimeout(this.delayTimer), q()
      },
      finishDrag() {
        ;(this.downEvent = null),
      ...
      createDragImage(e) {
        ...
        if (this.$slots['drag-image']) {
          ...
          s.childElementCount !== 1 ? (t = H(s)) : (t = H(s.children.item(0)))
        } else (t = H(this.$el)), (t.style.transform = e)
        return (
...
function jt(e, t, s, i, n, l) {
  return (
    ...
    G(
      yt(s.tag),
      { class: vt(e.cssClasses) },
      mt(
        {
          default: D(() => [
            ee(e.$slots, 'default', ye(we(e.$slots.default || {}))),
            e.dragInitialised ? (P(), j('div', Ht, [ee(e.$slots, 'drag-image')], 512)) : X('v-if', !0),
          ]),
          _: 2,
        },
        [pt(l.dynamicSlots, ([d, c]) => ({ name: d, fn: D(() => [ee(e.$slots, d, ye(we(c)))]) }))]
      ),
      1032,
      ['class']
    )
...
var Xt = {
    ...
    methods: {
      ...
      createDragImage() {
        ...
        if (this.$refs['drag-image']) {
          ...
          t.childElementCount !== 1 ? (e = H(t)) : (e = H(t.children.item(0))),
  ...
  Re = { name: 'DragFeedback' }
const Yt = { class: 'DragFeedback' }
function qt(e, t, s, i, n, l) {
  return P(), j('div', Yt, [ee(e.$slots, 'default')])
}
Re.render = qt
class Se {
  constructor(t, s, i, n) {
    ...
    for (const d of t) {
      ...
      const c = d.getBoundingClientRect(),
        f = d.classList.contains('dnd-drop') || d.getElementsByClassName('dnd-drop').length > 0
      let m = !1
      if (f) {
      ...
      n === null
        ? this.magnets.push(f ? this.before(c, m) : this.center(c))
        : this.magnets.push(f ? (n < l ? this.after : this.before)(c, m) : this.center(c)),
        l++
    }
  }
  center(t) {
  ...
  closestIndex(t) {
    ...
    let n = 999999,
      l = -1
    for (let d = 0; d < this.magnets.length; d++) {
      const c = this.magnets[d],
        f = Math.sqrt(Math.pow(c.x - s, 2) + Math.pow(c.y - i, 2))
      f < n && ((n = f), (l = d))
    }
    return l
  }
...
var Ue = {
  ...
  computed: {
    rootTag() {
      return this.noAnimations ? this.tag : gt
    },
    rootProps() {
  ...
  methods: {
    ...
    doDrop(e) {
      this.reordering
        ...
        : (Be(this, e), this.$emit('insert', new Qt(e.type, e.data, this.closestIndex)))
    },
    candidate(e) {
      return Fe(this, e) || this.reordering
    },
    ...
    computeInsertingGrid() {
      ...
      const i = new Se(s.children, this.items.length, this.direction, null)
      return s.removeChild(t), i
    },
    computeReorderingGrid() {
      return new Se(this.$el.children, this.items.length - 1, this.direction, this.fromIndex)
    },
    createDragImage() {
      let e
      if (this.$refs['drag-image']) {
  ...
  render() {
    ...
    return (
      ...
      Z(this.rootTag, { ref: 'component', class: this.clazz, ...this.rootProps }, { default: () => e })
    )
  },
}
Ue.__scopeId = 'data-v-230f65e3'
class Zt {
  constructor() {
...
new Zt()
const es = Y('h3', null, 'Selected files', -1),
  ts = { key: 0, class: 'text-grey' },
  ss = { key: 1, class: 'text-grey me-3' },
  is = { key: 0, class: 'bg-grey text-white rounded px-1' },
  ns = Y('h3', null, 'Available files', -1),
  rs = _e({
    __name: 'FileSelector',
    ...
    setup(e, { emit: t }) {
      const s = e,
        n = Et(s, 'modelValue', t)
      function l(g) {
        n.value.splice(g.index, 0, g.data)
      }
      const d = A(() => $t(s.files, (g) => ({ title: g.name }))),
        c = A(() => Pt(d.value, (g) => !n.value.includes(g.title))),
        f = Ee(te)
      function m(g) {
        return f.value.find((p) => p.filename === g)
      }
      function x(g) {
        const p = m(g)
        return p != null && p.duration
          ? `${Math.floor((p == null ? void 0 : p.duration) / 60)}:${((p == null ? void 0 : p.duration) % 60)
              .toString()
              .padStart(2, '0')}`
          : ''
      }
      return (g, p) => {
        const k = L('v-list-item'),
          E = L('v-chip'),
          S = L('v-icon'),
          T = L('v-btn'),
          v = L('v-list'),
                        ...
                        default: D(() => [
                          u(
                            _(Ue),
                            {
                              ...
                              class: 'list',
                              onInsert: l,
                              onReorder: p[0] || (p[0] = (r) => r.apply(_(n))),
                            },
                            {
                              empty: D(() => [
                                u(k, { color: 'primary' }, { default: D(() => [U('No files selected')]), _: 1 }),
                              ]),
                              item: D(({ item: r, index: b, reorder: C }) => [
                                (P(),
                                G(
                                  _(ne),
                                  { key: r },
                                  {
                                    default: D(() => [
                                      u(
                                        k,
                                        { color: 'primary', active: C },
                                        {
                                          append: D(() => [
                                            x(r)
                                              ? (P(),
                                                j('span', is, [
                                                  u(S, { size: 'sm', icon: 'far fa-clock mb-1 ' }),
                                                  U(' ' + R(x(r)), 1),
                                                ]))
                                              : X('', !0),
                                            u(
                                              T,
                                              {
                                                onClick: (y) => _(n).splice(_(n).indexOf(r), 1),
                                                icon: 'fas fa-close',
                                                variant: 'plain',
                                                style: { height: '32px' },
                                              },
                                          ...
                                          default: D(() => {
                                            var y, w, $, W, O
                                            return [
                                              u(E, null, { default: D(() => [U(R(b + 1), 1)]), _: 2 }, 1024),
                                              U(' ' + R(((y = m(r)) == null ? void 0 : y.name) || r) + ' ', 1),
                                              (w = m(r)) != null && w.key_signature
                                                ? (P(),
                                                  j(
                                                    'span',
                                                    ts,
                                                    ' (' + R(($ = m(r)) == null ? void 0 : $.key_signature) + ') ',
                                                    1
                                                  ))
                                                : X('', !0),
                                              (W = m(r)) != null && W.bpm
                              ...
                              feedback: D(({ data: r }) => [
                                ...
                                G(
                                  k,
                                  { color: 'primary', active: '', key: r },
                                  {
                                    append: D(() => [
                                      u(T, { icon: 'fas fa-close', variant: 'plain', style: { height: '32px' } }),
                                    ]),
                                    default: D(() => [U(R(r) + ' ', 1)]),
                                    _: 2,
                                  },
              ...
              u(
                ...
                { cols: '12', sm: '6', orderSm: '1' },
                {
                  default: D(() => [
                    ...
                    u(
                      _(Rt),
                      { items: c.value, density: 'compact', class: 'disable-active-underlay' },
                      {
                        item: D(({ props: r }) => [
                          (P(),
                          G(
                            _(ne),
                            { data: r.title, class: 'item', key: r.title },
                            {
                              default: D(() => [
                                u(
                                  _(le),
  ...
  os = { class: 'd-flex justify-space-between' },
  as = _e({
    ...
    setup(e) {
      ...
      c &&
        bt(c, (v) => {
          v && ((f.value = v), (m.value = v.songs.map((o) => t.value.find((a) => a.id == o).filename)))
        })
      const f = N({ id: '', name: '' }),
        m = N([])
      function x(v) {
        for (var o = [], a = new DataView(v), r = 0; r < a.byteLength; r += 4) {
          var b = a.getUint32(r),
            C = b.toString(16),
            y = '00000000',
            w = (y + C).slice(-y.length)
          o.push(w)
        }
        return o.join('')
      }
      ...
      async function k() {
        ...
        try {
          await Promise.all(
            m.value.map(async (o) => {
              var C, y
              t.value.find((w) => w.filename == o) || (await De(te, { filename: o, name: o }))
              const a = t.value.find((w) => w.filename == o),
                r = (C = Mt(S.value).find((w) => w.name == o)) == null ? void 0 : C.handle,
                b = x(
                  await window.crypto.subtle.digest(
                    'SHA-256',
                    new Uint8Array(
                      await ((y = await (r == null ? void 0 : r.getFile())) == null ? void 0 : y.arrayBuffer())
                    )
                  )
                )
              if (r && (!a.pdfStorageRef || a.pdfStorageSHA != b)) {
                console.log('Uploading file', o)
                const w = await T(r)
                await xe(be(te, a.id), { filename: o, pdfStorageRef: w.fullPath, pdfStorageSHA: b })
              }
            })
          )
          const v = {
            ...Ct(f.value, 'id', 'songs'),
            songs: m.value.map((o) => t.value.find((a) => a.filename == o).id),
          }
          l == 'create' ? await De(Ie, v) : await xe(d, v), i.push('/setlist')
        } catch (v) {
          console.error(v), (g.value = 'An unknown error occurred.')
        }
        p.value = !1
      }
      async function E() {
      ...
      async function T(v) {
        const o = St(),
          a = Tt(o, v.name)
        return await _t(a, await v.getFile(), { customMetadata: { originalFileName: v.name } }), a
      }
      return (v, o) => {
        const a = L('v-btn'),
          r = L('v-text-field')
        return (
          ...
          G(At, null, {
            default: D(() => [
              Y('h2', os, [
                Y('div', null, [
                  u(Ge, { to: _(xt) }, null, 8, ['to']),
                  U(' ' + R(_(l) == 'create' ? 'Create' : 'Update') + ' Setlist ', 1),
                ]),
                Y('div', null, [
                  _(l) == 'edit'
                    ? (P(),
                      G(
                        a,
                        { key: 0, onClick: E, color: 'error', class: 'ms-2', 'prepend-icon': 'fas fa-trash' },
                        { default: D(() => [U(' Delete ')]), _: 1 }
                      ))
                    : X('', !0),
                  u(
                    a,
                    { loading: p.value, color: 'primary', onClick: k, class: 'ms-2' },
                    { default: D(() => [U(R(_(l) == 'create' ? 'Create' : 'Update'), 1)]), _: 1 },
                    8,
                    ['loading']
                  ),
                ]),
              ...
              u(
                r,
                {
                  ...
                  'onUpdate:modelValue': o[0] || (o[0] = (b) => (f.value.name = b)),
                  label: 'Name',
                },
                null,
                8,
              ...
              u(
                rs,
                { modelValue: m.value, 'onUpdate:modelValue': o[1] || (o[1] = (b) => (m.value = b)), files: _(S) },
                null,
                8,
                ['modelValue', 'files']
              ),
  ...
  ms = Vt(as, [['__scopeId', 'data-v-37e0048e']])
